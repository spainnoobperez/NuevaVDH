! function(e) {
    ...
    function(e, t, n) {
        ...
        r.rpc = n(3), r.rpc.setUseTarget(!0), r.rpc.setPost(function(e, t) {
            ...
            /^weh:(.*?):(.*)/.exec(e.name) && (e.onMessage.addListener(function(t) {
                ...
                if (t) {
                    delete a[t];
                    var n = p[t];
                    n && (n.timer && clearTimeout(n.timer), delete p[t])
                }
            }))
        ...
        try {
            ...
            null === f ? i.storage.local.get("weh-prefs").then(function(e) {
                var t = e["weh-prefs"];
                t && o.assign(t)
            }) : (u = f, l = {}, JSON.parse(u).forEach(function(e) {
                l[e.name] = e.value
            }), d = l, c = s(f))
        } catch (e) {}
        o.assign(d), o.on("", {
            ...
            var n, o = (n = d, JSON.stringify(Object.keys(n).sort().map(function(e) {
                ...
                u = s(o);
            u != c && (c = u, localStorage.setItem("weh-prefs", o), i.storage.local.set({
                "weh-prefs": d
            })), Object.keys(a).forEach(function(t) {
            ...
            return r(e, [{
                ...
                value: function() {
                    ...
                    return new Promise(function(a, s) {
                        ...
                        var l = e || o.useTarget && o.posts[t] || o.post;
                        o.useTarget ? l(t, {
                            type: "weh#rpc",
                            _request: u,
                            _method: n,
                                ...
                                u = {
                                    ...
                                    get(e, u, l) {
                                        ...
                                        if ("function" == typeof c)
                                            if ("function" == typeof a[u]) c = n(e, e[u], a[u]);
                                            else if (r(o, u)) {
                                            let r = t(u, o[u]);
                                            c = n(e, e[u], r)
                                        } else c = c.bind(e);
                                        else {
                                            if ("object" != typeof c || null === c || !r(a, u) && !r(o, u)) return Object.defineProperty(s, u, {
                                                configurable: !0,
                                                enumerable: !0,
                                                get: () => e[u],
                                                set(t) {
    ...
    function(e, t, n) {
        ...
        t.hash = l, t.hashHex = function(e) {
            return Math.abs(l(e)).toString(16)
        }, t.gotoTab = c, t.gotoOrOpenTab = function(e) {
        ...
        var d = function() {
                ...
                return {
                    toByteArray: function(e) {
                        ...
                        var l = e.length;
                        s = "=" === e.charAt(l - 2) ? 2 : "=" === e.charAt(l - 1) ? 1 : 0, u = new i(3 * e.length / 4 - s), r = s > 0 ? e.length - 4 : e.length;
                        var c = 0;
    ...
    function(e, t, n) {
        ...
        n(40);
        var x = [];
        l.prefs.backgroundReduxLogger && x.push(s({
        ...
        function C() {
            ...
            var a = !1;
            (0 == n || "currenttab" == l.prefs.iconActivation && 0 == t) && (a = !0), A.browserAction.setIcon({
                path: p.icons({
        ...
        _.subscribe(I(function() {
            ...
            c.call("main", "progress", _.getState().progress)
        })), _.subscribe(P(function() {
            c.call("main", "logs", _.getState().logs), C()
        })), c.listen({
            getHits: function() {
                return _.getState().hits
            },
    ...
    function(e, t, n) {
        ...
        function p() {
            u(function() {
                ...
                return e += "?browser=" + (c.browser || ""), r.prefs.forcedCoappVersion && (e += "version=" + r.prefs.forcedCoappVersion), s.gotoOrOpenTab(e)
            })
        }
    ...
    function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            function n(e) {
                ...
                if ("running" != e.status && r != e.status) {
                    ...
                    if (e === n ? e = Object.assign({}, e, {
                        ...
                        var l = Date.now(),
                            c = 1e3 * i.prefs.orphanExpiration;
                        e.orphanT0 = l, e.orphanT = l + c, setTimeout(function() {
            ...
            switch (t.type) {
                case "hit.new":
                    if (!c.checkHitBlacklisted(t.payload)) {
                        var l = t.payload.id,
                            f = e[l],
                            p = n(f || {
                                status: "active"
                            }, t.payload);
                        p !== f && (e = Object.assign({}, e, r({}, l, p)))
                    }
                    break;
                ...
                case "hit.delete":
                    ...
                    Array.isArray(R) || (R = [R]), R.forEach(function(t) {
                        var n = e[t];
                        n && (e === D && (e = Object.assign({}, e)), delete e[t])
                    });
                    break;
                case "hit.orphanTimeout":
                    var T = t.payload,
                        q = e[T];
                    q && "orphan" == q.status && !isNaN(q.orphanT) && Date.now() > q.orphanT && delete(e = Object.assign({}, e))[T]
            }
            return e
    ...
    function(e, t, n) {
        ...
        function s() {
            o && clearTimeout(o), o = setTimeout(c, 50)
        }
        var u = "about:blank",
            l = {};
    ...
    function(e, t, n) {
        ...
        var u = n(1),
            ...
            T = t.Action = function() {
                function e(t) {
                    s(this, e), this.hit = Object.assign({}, t), this.reqs = {}, this.actionId = ++R, this.cleanupData = {
                        files: []
                    }
                }
                return i(e, [{
                ...
                return o(t, T), i(t, [{
                    ...
                    value: function() {
                        ...
                        return Promise.resolve(r(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "postJob", this).call(this)).then(function() {
                            ...
                            u.prefs.notifyReady && (e.hit.isPrivate && u.prefs.noPrivateNotification || l.notifications.create(e.hit.id, {
                                type: "basic",
                                title: u._("vdh_notification"),
                                message: u._("file_ready", e.filePath || e.hit.title || u._("media")),
                                iconUrl: l.extension.getURL("content/images/icon-36.png")
                            }))
                        }).then(function() {
        ...
        var M = function(e) {
                ...
                return o(t, q), i(t, [{
                    ...
                    value: function() {
                        ...
                        return P && I.matchHit(this.hit) ? (I.forbidden(), u.ui.close("main"), Promise.reject(new h.VDHError("Forbidden", {
                            ...
                            return u.openedContents().indexOf("main") >= 0 ? u.rpc.call("main", "embed", l.extension.getURL("content/dlconv-embed.html?panel=" + t)).then(function() {
                                return u.wait(t)
                            }).catch(function(e) {
            ...
            L = function(e) {
                ...
                return o(t, T), i(t, [{
                    key: "doJob",
                    value: function() {
                        return c.call("main", "copyToClipboard", this.hit.url)
                    }
                }], [{
                    key: "canPerform",
                    value: function(e) {
            ...
            K = function(e) {
                ...
                return o(t, T), i(t, [{
                    key: "doJob",
                    value: function() {
                        return c.call("main", "embed", l.extension.getURL("content/blacklist-embed.html?panel=blacklist#" + encodeURIComponent(this.hit.id))), Promise.resolve()
                    }
                }], [{
                    key: "canPerform",
                    value: function(e) {
        ...
        var Q = function(e) {
            ...
            return o(t, M), i(t, [{
                key: "getReqs",
                value: function() {
                    this.reqs.coappMin = "1.5.0", this.downloadWith, this.reqs.coapp = !0, this.reqs.checkLicense = !0, this.reqs.aggregate = !0
                }
            }, {
                key: "getStreams",
                value: function() {
                ...
                key: "mergePrepare",
                value: function() {
                    var e, n, r, i, a, o, s, l, c = this,
                        d = "mkv";
                    return g.selectMergeVideoFile(u.prefs.lastDownloadDirectory || "dwhelper").then(function(t) {
                        if (!t) throw new h.VDHError("No video file selected", {
                            noReport: !0
                        });
                        return e = t.fileName, n = t.directory, r = t.filePath, b.info(r, !0)
                    }).then(function(t) {
                        var r = t.streams.find(function(e) {
                            return "video" == e.codec_type
                        });
                        if (!r) throw new h.VDHError(u._("no_video_in_file", [e]));
                        return s = r.codec_name, g.selectMergeAudioFile(n)
                    }).then(function(e) {
                        if (!e) throw new h.VDHError("No audio file selected", {
                            noReport: !0
                        });
                        return i = e.fileName, a = e.directory, o = e.filePath, b.info(o, !0)
                    }).then(function(f) {
                        var p = {
                                mpeg4: 1,
                                h264: 1,
                        ...
                        if (!g) throw new h.VDHError(u._("no_audio_in_file", [i]));
                        l = g.codec_name, p[s] && p[l] && (d = "mp4");
                        ++t.idIndex;
                        var m = e,
                            v = /^(.*)\.([^\.]{1,5})$/.exec(e);
                        v && (m = v[1]), c.details = {
                        ...
                        }, c.hit.title = m, c.hit.extension = d
                    }).catch(function(e) {
        ...
        Q.idIndex = 0, X(q), X(M), X(F), X(U), X(N), X(W), X(L), X(z), X(V), X(H), X(K), X(B), X(J), c.listen({
            convertLocal: ee,
            mergeLocal: $
        })
    },
    function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            return new Promise(function(n, i) {
                var l = ["-y", "-i", e.source];
                e.wm && e.wm.qr && !e.config.audioonly && (l = l.concat(["-i", e.wm.qr, "-filter_complex", "[0:v][1:v] overlay=" + e.wm.x + ":" + e.wm.y]));
                l.concat([]);
                for (var c in e.config.params) {
                    var d = e.config.params[c];
                    null !== d && ("string" != typeof d || d.length > 0) && (l.push("-" + c), l.push("" + d))
                }
                if (e.config.extra) {
                ...
                e.config.audioonly && l.push("-vn"), l = l.concat(["-threads", r.prefs.converterThreads, "-strict", "experimental"]);
                var p = ++s;
                u[p] = t, e.config.twopasses ? console.warn("TODO implement 2 passes conversion") : (l.push(e.target), a.call("convert", l, {
                    progressTime: "" + p
                }).then(function(t) {
                    var a = t.exitCode,
                        s = t.stderr;
        ...
        var l = new o.Cache(function() {
            ...
            c = t.getOutputConfigs = l.get();

        function d(e) {
            return l.set(Object.assign({}, y, e))
        }
    ...
    function(e, t, n) {
                        ...
                        o = function(e, t) {
                            var n = function(e, t) {
                                ...
                                i = function(e, t) {
                                    ...
                                    a.WriteInt32(n, 0, 0), "audio" == t.streamType && l("mhlr", n, 4);
                                    "audio" == t.streamType ? l("soun", n, 8) : "video" == t.streamType && l("vide", n, 8);
                                    return a.WriteInt32(n, 12, 0), a.WriteInt32(n, 16, 0), a.WriteInt32(n, 20, 0), l("VideoHandler", n, 24), s("hdlr", n)
                                }(e, t),
                                o = function(e, t) {
                                    var n = "video" == t.streamType ? function(e, t) {
                                        ...
                                        l = function(e, t) {
                                            var n = function(e, t) {
                                                        ...
                                                        var i = function(e, t) {
                                                            ...
                                                            if (t.sampleSizes)
                                                                if (Array.isArray(t.sampleSizes))
                                                                    for (var l = 0; l < t.sampleSizes.length; l++) o += t.sampleSizes[l];
                                                                else
                                                                    for (var l = 0; l < t.sampleSizes.length; l++) o += a.ReadInt32(t.sampleSizes.data, 4 * l);
                                                            else if (Array.isArray(t.dataSizes))
                                                                for (var l = 0; l < t.dataSizes.length; l++) o += t.dataSizes[l];
                                                            else
                                                                for (var c = 12; c < t.dataSizes.length; c += 4) o += a.ReadInt32(t.dataSizes.data, c);
                                                ...
                                                o = function(e, t) {
                                                    ...
                                                    for (var o = [], u = Array.isArray(t.dataTimestamps) ? t.dataTimestamps.length : t.dataTimestamps.length / 2, r = 0; r < u;) {
                                                        ...
                                                        if (Array.isArray(t.dataTimestamps))
                                                            for (; r + c < u && t.dataTimestamps[r + c] <= t.dataTimestamps[r]; c++);
                                                        else
                                                            for (; r + c < u && a.ReadInt64(t.dataTimestamps.data, 8 * (r + c)) <= a.ReadInt64(t.dataTimestamps.data, 8 * r); c++);
                                                        r + c < u && (l = Array.isArray(t.dataTimestamps) ? (t.dataTimestamps[r + c] - t.dataTimestamps[r]) / c : (a.ReadInt64(t.dataTimestamps.data, 8 * (r + c)) - a.ReadInt64(t.dataTimestamps.data, 8 * r)) / c, t.declaredSampleRate && (l = Math.round(l * t.declaredSampleRate / 9e4))), r += c, !l || 0 != o.length && o[o.length - 1].duration == l ? o.length > 0 && (o[o.length - 1].count += c) : o.push({
                                                            duration: l,
                                                            count: c
                                                        })
                                                    }
                                                ...
                                                l = "video" == t.streamType ? function(e, t) {
                                                ...
                                                d = e.multiMdat ? function(e, t) {
                                                    ...
                                                    for (var o = 0; o < n; o++) {
                                                        var u, l = (u = "object" == r(t.dataOffsets[o]) ? t.dataOffsets[o] : {
                                                            b: t.dataOffsets[2 * o],
                                                            o: t.dataOffsets[2 * o + 1]
                                                        }).o + e.mdatOffsets[u.b];
                                                        a.WriteInt32(i, 8 + 8 * o, Math.floor(l / 4294967296)), a.WriteInt32(i, 12 + 8 * o, 4294967295 & l)
                                                    }
                                                    return s("co64", i)
                                                }(e, t) : function(e, t) {
                                                    var n = "object" == r(t.dataOffsets[0]) ? t.dataOffsets.length : t.dataOffsets.length / 2,
                                                    ...
                                                    for (var o = 0; o < n; o++) {
                                                        ...
                                                        a.WriteInt32(i, 8 + 4 * o, l)
                                                    }
                                                    return s("stco", i)
                                                }(e, t);
                                            return s("stbl", [n, o, l, c, i, d])
                                        }(e, t);
                                    return s("minf", [n, i, o, l])
                                }(e, t);
                            return s("mdia", [n, i, o])
                        }(e, n),
                        c = function(e, t) {
        ...
        function s(e, t) {
            var n = c(t),
                r = new Uint8Array(4);
            return a.WriteInt32(r, 0, 8 + n), [r, l(e = (e + "    ").substr(0, 4)), t]
        }
        ...
        t.length = c, t.flatten = d, t.firstBuffer = function e(t) {
        ...
        t.writeMulti = p, t.writeFileHeader = function(e, t) {
            ...
            if (e.init && e.init.ftyp) n = s("ftyp", e.init.ftyp);
                ...
                a.WriteInt32(r, 0, 512), n = s("ftyp", [l("isom"), r, l("isomiso2avc1mp41")])
            }
            var u = s("free", []);
            e.fileSize = e.lastDataIndex = c(n) + c(u);
            var d = i,
                f = {
                    write: !0,
                    append: !1,
    ...
    function(e, t, n) {
        ...
        t.matchHit = function(e) {
            ...
            var e = i._("chrome_noyt_text"),
                t = u.hash(e),
                n = i._("chrome_noyt_text3"),
                r = u.hash(n),
                a = n; - 1960581238 == r && -1126813505 != t && (a = e);
            p.alert({
                title: i._("chrome_warning_yt"),
                text: [a, i._("chrome_noyt_text2")],
                height: 400,
                buttons: [{
            ...
            if (!r) return null;
            for (var a = r[1], u = (new DOMParser).parseFromString(t, "application/xml").querySelectorAll("AdaptationSet"), l = {}, c = 0, d = [], f = 0; f < u.length; f++) {
            ...
            return function(e) {
                ...
                t.forEach(function(e) {
                    e.audioMpd = l[e.audioUrl], e.videoMpd = l[e.videoUrl], e.audioMpd && e.videoMpd && o.dispatch("hit.new", e)
                })
            }
        };
        var i = n(1),
                ...
                return r(e, [{
                    ...
                    value: function(e) {
                        ! function(e, t) {
                            ...
                            if (!l) return null;
                            var c = {};
                            l[1].split("&").forEach(function(e) {
                                var t = /^(.*?)=(.*)$/.exec(e);
                                t && (c[t[1]] = t[2])
                            }), u.variants[a] = {
                                url: n.replace(/(\?|&)range=[0-9]+\-[0-9]+&?/, "$1"),
                                itag: a,
                                type: decodeURIComponent(c.mime),
                                clen: c.clen
                            }, /^audio/.test(c.mime) && (u.audio = !0);
                            /^video/.test(c.mime) && (u.video = !0);
                            ...
                            var p = s.getHitsFromVariants({
                                ...
                                duration: c.dur ? Math.round(c.dur) : void 0,
                                group: "grp-" + r,
                                headers: t.headers,
                                proxy: t.proxy,
                                possibleContentRedirect: !0
                            ...
                            n(function(e, t) {
                                ...
                                if (n.player_response) try {
                                    var u = JSON.parse(n.player_response),
                                        l = u.streamingData;
                                    if (l && ["adaptiveFormats", "formats"].forEach(function(e) {
                                        var t = l[e];
                                        Array.isArray(t) && t.forEach(function(e) {
                                            e.url && i.push(e)
                                        })
                                    }), u.videoDetails && u.videoDetails.thumbnail && u.videoDetails.thumbnail.thumbnails) {
                                        var c = u.videoDetails.thumbnail.thumbnails;
        ...
        function E(e) {
            var t = ["var _$vdhData = " + JSON.stringify({
                tabId: e.tabId
            }) + ";", "var _$vdhSmartNameSpecs = " + JSON.stringify(c.getSpecs(e.url)) + ";"];
    ...
    function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            s(e, "error")
        }, t.log = s, t.clear = u, t.logDetails = l, t.getEntry = c;
        var r = n(1),
            i = r.browser,
            a = n(12),
            o = 0;
            ...
            return r(e, [{
                ...
                value: function(e) {
                    ...
                    return new Promise(function(n, r) {
                        var a = 0;
                        ! function s(u, l) {
                            var c = e.subarray(u, l).toString();
                            i.call("fs.write", t.fd, c, 0, l - u, t.position).then(function(r) {
            ...
            return r(e, [{
                ...
                value: function(e, t) {
                    ...
                    if (this.pendingAppend = this.pendingAppend || [], this.pendingAppend.push({
                        ...
                        n.masked && (i = l, o.iv = n.biniv, o.key = n.cryptoKey);
            ...
            return function(e) {
                return function(n, a, o) {
                    ...
                    return l = t.map(function(e) {
                        return e(c)
                    }), u = r.a.apply(void 0, l)(s.dispatch), i({}, s, {
                        dispatch: u
                    })
                }
            }
        ...
        (function(e) {
            (function(t) {
                ...
                function c(e, t, n, r, d, f, p) {
                    ...
                    if (!y && b) n(new a(h, t));
                    ...
                    else if (l(e) !== l(t)) n(new i(h, e, t));
                    else if ("date" === l(e) && e - t != 0) n(new i(h, e, t));
                        ...
                        if (p.filter(function(t) {
                            ...
                            if (p.push({
                                ...
                                var w;
                                for (e.length, w = 0; w < e.length; w++) w >= t.length ? n(new s(h, w, new o(void 0, e[w]))) : c(e[w], t[w], n, r, h, w, p);
                                ...
                                k.forEach(function(i, a) {
                                    var o = A.indexOf(i);
                                    o >= 0 ? (c(e[i], t[i], n, r, h, i, p), A = u(A, o)) : c(e[i], void 0, n, r, h, i, p)
                ...
                function g(e, t) {
                    ...
                    e.forEach(function(i, d) {
                        ...
                        var C = a(A, I, b);
                        try {
                            _ ? s.title && c ? n.groupCollapsed.apply(n, ["%c " + C].concat(P)) : n.groupCollapsed(C) : s.title && c ? n.group.apply(n, ["%c " + C].concat(P)) : n.group(C)
                        } catch (e) {
                            n.log(C)
                        }
                        ...
                        if (S)
                            if (s.prevState) {
                                ...
                                n[S]("%c prev state", R, v)
                            } else n[S]("prev state", v);
                        if (E)
                            if (s.action) {
                                var T = "color: " + s.action(A) + "; font-weight: bold";
                                n[E]("%c action    ", T, A)
                            } else n[E]("action    ", A);
                        if (y && j)
                            if (s.error) {
                        ...
                        if (D)
                            if (s.nextState) {
                                ...
                                n[D]("%c next state", M, k)
                            } else n[D]("next state", k);
                        l && p(v, k, n, _);
                        try {
                            n.groupEnd()
                        } catch (e) {
                    ...
                    return function(e) {
                        ...
                        return function(e) {
                            return function(l) {
                                ...
                                var c = {};
                                u.push(c), c.started = k.now(), c.startedTime = new Date, c.prevState = r(n()), c.action = l;
                                var d = void 0;
                                if (o) try {
                                    d = e(l)
                                } catch (e) {
    ...
    function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.dialog = s, t.alert = u, t.fileDialog = l, t.saveAs = function(e, t) {
        ...
        }, t.selectDirectory = c, t.selectConvertFiles = function(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return l(Object.assign({
                directory: e,
                uniqueFilename: !1,
    ...
    function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            if (o)
                if (0 == t[0] && 0 == t[1] && (1 == t[2] || 0 == t[2] && 1 == t[3]))(n = l(t, 0, t.length)).unshift(o);
                else {
                    var s = new Uint8Array(o.s + 3 + t.length);
                    s.set(o.data.subarray(o.o - 3, o.o + o.s), 0), s.set(t, o.s + 3), n = l(t = s, 0, t.length)
                } else n = l(t, 0, t.length);
            ...
            for (var v = i.gotUnitStart || !1, y = i.keyFrame || !1, b = i.frameUnit || !1, w = i.avccData || [], k = i.avccSize || 0, x = !1, d = 0; d < u; d++) {
                ...
                if (0 != f.s) {
                    ...
                    if (9 == p) {
                        ...
                        v = !0
                    } else 5 == p ? (0 != f.data[f.o + 1] && (y = !0), b = !0) : 1 == p && (b = !0); if (v) {
        ...
        function c(e, t, n) {
            ...
            if (!A) i(r);
            i(r);
            if (i(r) && (u = o(r), l = o(r), c = o(r), d = o(r)), i(r)) {
                if (i(r))
            ...
            var _ = 16 * (k + 1) - 2 * d - 2 * c,
                I = (2 - A) * (x + 1) * 16 - 2 * l - 2 * u;
            return {
        ...
        var I = function() {
                    ...
                    value: function() {
                        ...
                        if (this.handler) this.handler(this.hitData);
                            ...
                            !r || n && "audio" == u.prefs.dashOnAdp ? (i = this.mpd.audio, a = null) : (!n || r && "video" == u.prefs.dashOnAdp) && (a = null), i.forEach(function(n, r) {
                                ...
                                o._mpdCommonBaseUrl = t.mpd.base_url, n.width && n.height && (o.size = n.width + "x" + n.height), n.duration && (o.duration = Math.round(n.duration)), l.dispatch("hit.new", o)
                            })
                        }
                    }
                }]), t
            ...
            P = function(e) {
                ...
                return o(t, I), i(t, [{
                    ...
                    key: "handle",
                    value: function() {
                        this.master ? c.handleMaster(this.master, this.hitData) : this.media && c.handleMedia(this.media, this.hitData, this.mediaUrl)
                    }
                }]), t
            }(),
            C = {},
                ...
                return o(t, I), i(t, [{
                    ...
                    value: function(e) {
                        ...
                        for (i = 0; i < u.length; i++) {
                            var l = u.item(i),
                                c = l.getAttribute("bootstrapInfoId"),
                                d = this.medias[c];
                            if (d) {
                                d.bitrate = 1e3 * parseInt(l.getAttribute("bitrate")), d.urlHint = new URL(l.getAttribute("url"), this.f4fUrl).href;
                                var p = l.querySelector("metadata");
                                if (p) {
                    ...
                    value: function() {
                        ...
                        for (var t in this.medias) {
                            ...
                            if (this.skipManifest)
                                if (l.getF4fHitDataByUrlHint(n.urlHint)) continue;
                            ...
                            for (var r = e.url;;) {
                                ...
                                if (o) delete t.waitingForFrag[r];
                                    ...
                                    for (var s in t.waitingForFrag) {
                                        ...
                                        for (var c in u.medias) {
                                            if (u.medias[c].urlHint == r) {
                                ...
                                if (o) return l.getF4fHitDataByUrlHint(n[1]) ? null : (o.startFrag || (o.startFrag = parseInt(n[2])), o.postFrag || (o.postFrag = n[3]), o.checkReady(), null)
                            }
                        return null
                    }
                }, {
    ...
    function(e, t, n) {
        ...
        function m(e, t, n, r) {
            ...
            var l = r["EXT-X-STREAM-INF"];
            return l && (s.size = l.RESOLUTION || s.size, s.bitrate = parseInt(l.BANDWIDTH) || s.bitrate), o.dispatch("hit.new", s), new y(s)
        }
        ...
        function v(e, t, n) {
            ...
            var l = o.getHit("hls:" + r);
            if (l) {
                var c = 0;
                i.chunkDuration = 1e3, i.recording || a.prefs.hlsRememberPrevLiveChunks || (i.chunks = [], i.chunksMap = {}, i.segmentsCount = 0), e.walkThrough(function(t, n) {
                    var r = n.EXTINF;
                    if (r) {
                        var a = Math.round(1e3 * parseFloat(r));
                        a > i.chunkDuration && (i.chunkDuration = a)
                    }
                    var o = u.hashHex(t);
                    if (!(o in i.chunksMap)) {
                        c++, i.chunksMap[o] = 1;
                        var s = {
                            ...
                            d = n["EXT-X-KEY"];
                        d && "NONE" != d.METHOD && (s.encrypt = d, s.iv = parseInt(e.tags["EXT-X-MEDIA-SEQUENCE"] || "0") + s.index), i.chunks.push(s), r && (l.durationFloat += parseFloat(r), l.duration = Math.round(l.durationFloat))
                    }
                }), s.update(l.id, {
                    durationFloat: l.durationFloat,
                    duration: l.duration
            ...
            return function(e, t) {
                ...
                value: function(e, t, n, r, i) {
                    ...
                    this.aborted = !1, this.action = e, this.specs = t, this.successFn = function() {
                        ...
                        r.apply(o, arguments)
                    }, this.progressFn = i, this.downloadTarget = t[0].fileName, this.nextTrackId = 1, this.processedSegmentsCount = 0, this.recording = !0, this.masked = !!e.masked, this.masked && (this.biniv = e.biniv, this.cryptoKey = e.cryptoKey), this.segmentsCount || this.requestMediaManifest(), a.prefs.hlsDownloadAsM2ts ? (o.recording = !0, o.handle()) : l.writeFileHeader(this, function(e) {
                        e ? r(e) : (o.recording = !0, o.handle())
                ...
                key: "downloadChunk",
                value: function(e, t) {
                    e.encrypt ? this.downloadEncryptedChunk(e, t) : c.MP2TChunkset.prototype.downloadChunk.call(this, e, t)
                }
            }, {
                ...
                value: function(e, t) {
                    ...
                    function i(r, i, a) {
                        ...
                        c.MP2TChunkset.prototype.downloadChunk.call(n, e, function(r) {
                            if (r) return t.call(n, r, e);
                    ...
                    f.WriteInt32(s, 12, o), this.keys || (this.keys = {}), Array.isArray(this.keys[e.encrypt.URI]) ? this.keys[e.encrypt.URI].push(function(e, t) {
                        i.call(n, e, t, s)
                    }) : "object" == r(this.keys[e.encrypt.URI]) ? i(null, this.keys[e.encrypt.URI], s) : (this.keys[e.encrypt.URI] = [
                        function(e, t) {
                            i.call(n, e, t, s)
                        }
                ...
                value: function() {
                    ...
                    this.requestMediaManifest(), setTimeout(function() {
                        ...
                        t.recording && e == t.segmentsCount && c.MP2TChunkset.prototype.outOfChunks.call(t)
                    }, n)
                }
            }, {
                ...
                key: "finalize",
                value: function(e, t) {
                    c.MP2TChunkset.prototype.finalize.call(this, e, t), delete g[this.id]
                }
            }, {
                ...
                value: function() {
                    this.id;
                    delete g[this.id], c.MP2TChunkset.prototype.setNewId.call(this), g[this.id] = this, this.requestMediaManifest()
                }
            }]), t
        }()
    },
                ...
                if (0 != n.length && "#EXTM3U" == n[0].trim()) {
                    ...
                    if (0 != i.length) {
                        for (var l in i[0].tags) {
                            ...
                            d && (this.tags[l] = this.parseAttrs(c))
                        }
                        for (o = 0; o < i.length; o++) {
                            ...
                            for (var l in f.tags) void 0 === this.tags[l] && (p.tags[l] = this.parseAttrs(f.tags[l]));
    ...
    function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
                ...
                if (t.url && !(u && !n.keepProtected && t.s && t.s.length > 0)) {
                    ...
                    if (h = h || "mp4", "audio/video" === d) {
                        ...
                        if (void 0 === g) {
                            ...
                            t.size && b.push(t.size), b.push(h.toUpperCase()), p && b.push("V/" + p), f && b.push("A/" + f), c.variants.full[o].label = b.join(" - "), c.variants.full_list.push(o)
                        } else !t.size && g.size && (y.size = g.size)
                    } else {
                        var x, A;
                        if ("audio" == d ? (x = "adp_audio", A = "adp_video") : (x = "adp_video", A = "adp_audio"), void 0 === c.variants[x][t.itag]) {
                            var _ = {
                                extension: h
                            };
                            for (var I in t.size && (_.size = t.size), t.bitrate && (_.bitRate = t.bitrate), t.fps && (_.fps = t.fps), l = !0, c.variants[x][t.itag] = _, c.variants[A]) "audio" == d ? c.variants.adp_list.push(I + "/" + t.itag) : c.variants.adp_list.push(t.itag + "/" + I);
                            "audio" == d ? (c.variants[x][t.itag].codec = f, c.variants.adp_list.push("/" + t.itag)) : (c.variants[x][t.itag].codec = p, c.variants.adp_list.push(t.itag + "/"))
                        }
                    }
                }
            });
            for (var f = e.maxVariants || r.prefs.qualitiesMax, p = 0, h = [], g = null, m = 0; m < c.variants.full_list.length && (!f || p < f); m++) {
                var v = c.variants.full_list[m],
                    y = /^adp:([0-9]+)$/.exec(v);
                if (y) {
                    if (r.prefs.adpHide) continue;
                    g || (g = [], c.variants.adp_list.forEach(function(t) {
                        if (!n.audioAndVideo || /^\d+\/\d+$/.test(t)) {
                            var r = o.exec(t);
                            if ((!(r[1].length > 0) || i[r[1]]) && (!(r[1].length > 0 && c.variants.adp_video[r[1]] && "vp9" == c.variants.adp_video[r[1]].codec && c.converter) || c.converter.vp9support) && (!(r[2].length > 0) || i[r[2]])) {
                                var a = i[r[1]],
                                    s = i[r[2]],
                                    u = {
                                    ...
                                    d = null,
                                    f = null;
                                a && (u.videoUrl = a.url, a.clen && (l += parseInt(a.clen)), s || (u.url = u.videoUrl), a.s && u._signature.push(a.s), d = c.variants.adp_video[r[1]], u.extension = a.extension || (d ? d.extension : void 0), a.size && (u.size = a.size), !u.size && d && d.size && (u.size = d.size), a.fps && (u.fps = a.fps), !u.fps && d && d.fps && (u.fps = d.fps)), s && (f = c.variants.adp_audio[r[2]], u.audioUrl = s.url, s.clen && (l += parseInt(s.clen)), a || (u.url = u.audioUrl, u.extension = s.extension), s.s && u._signature.push(s.s)), f && d && f.extension != d.extension && (u.extension = "mkv"), l && (u.length = l), u.group = e.group, g.push(u)
                            }
                        }
                    }));
            ...
            c.variants.adp_list.sort(function(e, t) {
                var n = s.exec(e),
                    r = s.exec(t),
                    i = c.variants.adp_video[n[1]],
                    a = c.variants.adp_video[r[1]],
                    o = c.variants.adp_audio[n[2]],
                    u = c.variants.adp_audio[r[2]],
                    l = i && parseInt(i.size) || 0,
        ...
        function f() {
            var e = [],
                ...
                n = 1;
            for (c.variants.full_list.forEach(function(i) {
                if (u.test(i)) {
                    if (n > t) return;
                    e.push({
                        id: "adp:" + n,
        ...
        function p(e) {
            c.variants.full_list = [], e.forEach(function(e) {
                c.variants.full_list.push(e.id), u.test(e.id) || (c.variants.full[e.id].enabled = e.enabled)
            })
        }

        function h() {
            var e = [];
            return c.variants.adp_list.forEach(function(t) {
                var n = s.exec(t);
                if (t) {
                    var i = c.variants.adp_video[n[1]],
                        a = c.variants.adp_audio[n[2]];
                    if (i || a) {
                        var o = [];
        ...
        function g(e) {
            c.variants.adp_list = [], e.forEach(function(e) {
                c.variants.adp_list.push(e.id)
            })
        }
        i.storage.local.get({
            variants: l
        }).then(function(e) {
            c.variants = e.variants
        }).catch(function(e) {
    ...
    function(e, t, n) {
        ...
        function d() {
            l && clearTimeout(l), l = setTimeout(c, 100)
        }
        ...
        t.analyzePage = l, r.rpc.listen({
            ...
            galleryGroups: function(e) {
                Object.keys(e.groups).forEach(function(t) {
                    ...
                    var l = void 0;
                    if (n.extensions) {
                        var c = Object.keys(n.extensions);
                        c.sort(function(e, t) {
                        ...
                        c.forEach(function(e) {
                            ...
                            d.push(t)
                        }), l = r._("gallery_files_types", d.length > 0 && d.join(", ") || "" + n.urls.length)
                    }
            ...
            "complete" === t.status && r.prefs.medialinkAutoDetect && l(e)
        })
    },
    function(e, t, n) {
        "use strict";
        ...
        var P = function(e) {
            ...
            if (E && (t = E[e.requestId]) && delete E[e.requestId], !(e.tabId < 0)) {
                var n = l.networkHook(e.url, e) || c.networkHook(e.url, e, t, T && T[e.requestId]),
                    _ = !!n;
            ...
            function U(n) {
                if (_ || !(!C && isNaN(j) && !q || !C && !q && (isNaN(j) || 0 === r.prefs.mediaweightThreshold || j < r.prefs.mediaweightThreshold) || !isNaN(j) && j < r.prefs.mediaweightMinSize || C && "ms-asf" == C[2].toLowerCase() || C && "f4f" == C[2].toLowerCase())) {
                    ...
                    if (isNaN(j) || (u.length = j), e.proxyInfo && "http" == e.proxyInfo.type.substr(0, 4) && (u.proxy = e.proxyInfo), !r.prefs.tbsnFilterOut || !w.test(e.url)) {
                        var l = O["content-disposition"];
                        if (l) {
                            var c = h.exec(l);
                            c && c[1] && (u.headerFilename = c[1])
                        }
                        var f = g.exec(e.url);
        ...
        var E = null,
            j = function(e) {
                N(e), E && (E[e.requestId] = e.requestHeaders)
            },
            D = function(e) {
                N(e), E && delete E[e.requestId]
            };

        function R() {
            E = {}, d.webRequest.onSendHeaders.addListener(j, {
                urls: ["<all_urls>"]
            }, ["requestHeaders"]), d.webRequest.onErrorOccurred.addListener(D, {
                urls: ["<all_urls>"]
            })
        }
        r.prefs.on("monitorNetworkRequests", function(e, t) {
            t ? R() : (d.webRequest.onSendHeaders.removeListener(j), d.webRequest.onErrorOccurred.removeListener(D), E = null)
        }), r.prefs.monitorNetworkRequests && R();
        var T = null,
            q = function(e) {
                T && "POST" === e.method && e.requestBody && e.requestBody.formData && (T[e.requestId] = e.requestBody.formData)
            },
            M = function(e) {
                T && delete T[e.requestId]
            };

        function F() {
            T = {}, d.webRequest.onBeforeRequest.addListener(q, {
        ...
        r.prefs.on("tbsnEnabled", function(e, t) {
            t ? F() : (d.webRequest.onBeforeRequest.removeListener(q), d.webRequest.onErrorOccurred.removeListener(M), T = null)
    ...
    function(e, t, n) {
        ...
        r.rpc.listen({
            ...
            "install" == e.reason ? u.gotoOrOpenTab("https://www.downloadhelper.net/welcome?browser=" + (o.browser || "") + "&version=" + s.version) : "update" != e.reason || e.previousVersion == i.runtime.getManifest().version || "7.2.1" == s.version || "7.2.2" == s.version || "7.3.1" == s.version && "7.3.0" == e.previousVersion || "7.3.3.0" == s.version && "7.3.3.1" == e.previousVersion || "7.3.3.1" == s.version && "7.3.3.2" == e.previousVersion || "7.4.0.1" == s.version && "7.4.0.0" == e.previousVersion || /^7\.3\.7(\.\d+)?$/.test(s.version) || u.gotoOrOpenTab("https://www.downloadhelper.net/update?browser=" + (o.browser || "") + "&from=" + e.previousVersion + "&to=" + s.version)
        })
    },
    function(e, t, n) {
        "use strict";
                                ...
                                l(c).then(function(n) {
                                    if (!n) return function(e, t) {
                                        return new Promise(function(n, a) {
                                            ...
                                            o.windows.getCurrent().then(function(c) {
                                                var d = t.width || 500,
                                                    f = t.height || 400,
                                                    p = {
                                                        url: l,
                                                        ...
                                                        height: f,
                                                        type: "popup",
                                                        left: Math.round((c.width - d) / 2 + c.left),
                                                        top: Math.round((c.height - f) / 2 + c.top)
                                                    };
                                                return i.isBrowser("chrome", "opera") && (p.focused = !0), o.windows.create(p).then(function(t) {
                                                    ...
                                                    function d(e) {
                                                        e != c.id && t.autoClose && o.windows.getCurrent().then(function(e) {
                                                            e.id != c.id && o.windows.remove(c.id).then(function() {}, function() {})
                                                        })
                                                    }
                                                    Promise.resolve().then(function() {
                                                        return t.initData && t.initData.autoResize ? void 0 : o.windows.update(c.id, {
                                                            height: c.height + 1
                                                        }).then(function() {
                                                            return o.windows.update(c.id, {
                                                                height: c.height - 1
                                                            })
                                                        })
                                                    }).then(function() {
                                                        var e = new Promise(function(e, t) {
                                                                ...
                                                                function r(t) {
                                                                    t.windowId == c.id && (clearTimeout(n), o.tabs.onCreated.removeListener(r), e(t))
                                                                }
                                                        ...
                                                        t == c.id && (o.windows.onFocusChanged.removeListener(d), o.windows.onFocusChanged.removeListener(e))
                                                    })
                                                }).catch(a)
                                            }).catch(a)
                                        })
        ...
        o.runtime.onMessageExternal && (o.runtime.onMessageExternal.addListener(function(e, t, n) {
            switch (e.type) {
                case "weh#inspect-ping":
                    ...
                    break;
                case "weh#inspect":
                    s = t.id, (l = e.inspected) ? i.setHook(function(e) {
                        l && s && o.runtime.sendMessage(s, {
                            type: "weh#inspect-message",
                            message: e
                        }).catch(function(e) {
                            console.info("Error sending message", e), l = !1
                        })
                    }) : i.setHook(null), n({
                        type: "weh#inspect",
                        version: 1,
            ...
            function o(e) {
                var o, s = function(e) {
                    return Object.keys(s).reduce(function(t, n) {
                        return "create" === n ? t : ("function" == typeof s[n] && (t[n] = s[n].bind(s, e)), t)
                    }, {})
                };
                ...
                function l(t, n, r, i) {
                    ...
                    if ("string" == typeof n) return l(t, n.split(".").map(a), r, i);
                    var o = n[0],
                        s = u(t, o);
                    if (e.includeInheritedProps && ("__proto__" === o || "constructor" === o && "function" == typeof s)) throw new Error("For security reasons, object's magic properties cannot be set");
                    return 1 === n.length ? (void 0 !== s && i || (t[o] = r), s) : (void 0 === s && ("number" == typeof n[1] ? t[o] = [] : t[o] = {}), l(t[o], n.slice(1), r, i))
                }
                return o = (e = e || {}).includeInheritedProps ? function() {
                    return !0
                } : function(e, n) {
                    ...
                    var a = s.get(e, t);
                    r = ~~r, i(a) || (a = [], s.set(e, t, a)), a.splice(r, 0, n)
                }, s.empty = function(e, t) {
                    var a, u;
                    if (!n(t) && (null != e && (a = s.get(e, t)))) {
                        if ("string" == typeof a) return s.set(e, t, "");
                        if (function(e) {
                            return "boolean" == typeof e || "[object Boolean]" === r(e)
                        }(a)) return s.set(e, t, !1);
                        if ("number" == typeof a) return s.set(e, t, 0);
                        if (i(a)) a.length = 0;
                        else {
                            if (! function(e) {
                                return "object" == typeof e && "[object Object]" === r(e)
                            }(a)) return s.set(e, t, null);
                            for (u in a) o(a, u) && delete a[u]
                        }
                    }
                }, s.push = function(e, t) {
                    var n = s.get(e, t);
                    ...
                    var r = a(t[0]);
                    return o(e, r) ? 1 !== t.length ? s.del(e[r], t.slice(1)) : (i(e) ? e.splice(r, 1) : delete e[r], e) : e
                }, s
            }
            var s = o();
    ...
    function(e, t, n) {
        ...
        function p() {
            var e = Object.keys(l).length;
            c && 0 == e ? (clearInterval(c), c = null) : !c && e > 0 && (c = setInterval(h, s))
        }
                ...
                f(t.data).search({
                    ...
                    if (n.length > 0) {
                        ...
                        if ("in_progress" == i.state) {
                            ...
                            o != t.lastProgress && (t.lastProgress = o, t.progress(o)), i.error && (f(t.data).cancel(i.id), t.failure(new a.DetailsError(r._("download_error"), i.error)), delete l[e], p())
                        } else delete l[e], p(), "complete" == i.state ? setTimeout(function() {
        ...
        t.download = function(e, t, n, o) {
            ...
            p(), c.lastProgress = -1;
            var d = {
                url: c.data.source.url,
                conflictAction: "uniquify",
                filename: c.data.target.filename,
                directory: c.data.target.directory,
                saveAs: c.data.target.saveAs || !1,
                incognito: !!c.data.source.isPrivate
            };
            return c.data.source.headers ? d.headers = c.data.source.headers : c.data.source.referrer && (d.headers = [{
                name: "Referer",
                value: c.data.source.referrer
            }]), c.data.proxy && r.prefs.coappUseProxy && (d.proxy = c.data.proxy), Promise.resolve(i.runtime.getBrowserInfo && i.runtime.getBrowserInfo() || null).then(function(e) {
                return (!e || "Firefox" != e.name || parseInt(e.version) <= 56) && delete d.incognito, f(c.data).download(d)
            }).then(function(e) {
                if (!e) return m(c, new Error(r._("aborted"))), void p();
                c.downloadId = e, l[c.id] = c, p()
            }).catch(function(e) {
                m(c, new a.DetailsError(r._("download_error"), e.message))
            }), s
        }, t.abort = function(e) {
            l[e] && f(l[e].data).cancel(l[e].downloadId)
        }
    },
    function(e, t, n) {
        "use strict";
        ...
        var i = n(1),
            ...
            u = s.Chunkset,
            l = s.Codecs,
            c = n(263)("background/mp2t-worker.js", {
                name: "MP2TWorker",
                autoKill: 6e4
            });
        t.MP2TChunkset = function(e) {
            function t(e) {
                ...
                return n.rawAppendData = i.prefs.hlsDownloadAsM2ts, n.codecs = l, n.captureRaw = i.prefs.mpegtsSaveRaw, n.captureRawStreams = i.prefs.mpegtsSaveRawStreams, n.endsOnSeenChunk = i.prefs.mpegtsEndsOnSeenChunk, n.pesTable = {}, n.processQueue = [], n.workerWorking = !1, n
            }
            return function(e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                        ...
                        function e() {
                            if (!n.workerWorking) {
                                ...
                                if (t) {
                                    ...
                                    c.call("processData", r, t.data).then(function(i) {
        ...
        function i(e, t, n) {
            ...
            switch (n) {
                case 2:
                    ...
                    return {
                        offset: t + 3 + a,
                        value: String.fromCharCode.apply(null, e.subarray(t + 3, t + 3 + a))
                    };
                case 3:
                    var o = {};
                ...
                case 0:
                    return {
                        offset: t + 9,
                        value: new DataView(e.buffer).getFloat64(t + 1)
                    };
                case 1:
                    return {
                        offset: t + 2,
                    ...
                    for (var n = s.getTags("mdat", e), r = [], i = 0; i < n.length; i++)
                        for (var a = n[i].data, u = 0; u < e.length;) {
                            var l = u,
                                ...
                                d = o.ReadInt24(a, u);
                            u += 10;
                            var f = a.subarray(l, u + d + 4);
                            8 != c && 9 != c || r.push(f), u += d, u += 4
                        }
                    var p = s.flatten(r);
                    t.call(this, null, p)
                }
            ...
            return function(e, t) {
                ...
                value: function(e, t) {
                    ...
                    for (var f = u.getTags("traf", r[0].data), p = 0, h = f.length; p < h; p++) {
                        ...
                        var C = (131072 & q) >>> 17 >>> 0,
                            S = 8;
                        A ? (c = s.ReadInt64(v, S) - this.globalOffset, S += 8) : (C || 0 == c) && (c = i), _ && (b.sampleDescriptionIndex = s.ReadInt32(v, S), S += 4), I && (b.defaultSampleDuration = s.ReadInt32(v, S), S += 4), O && (b.defaultSampleSize = s.ReadInt32(v, S), S += 4), P && (b.defaultSampleFlags = s.ReadInt32(v, S), S += 4);
                        for (var E = u.getTags("trun", g.data), j = 0, D = E.length; j < D; j++) {
                            var R = E[j],
                                T = {
                                    s: 0,
                                    o: 0,
                            ...
                            for (var B = 0; B < V; B++) {
                                var J = {};
                                N ? (J.d = s.ReadInt32(M, H), H += 4) : J.d = b.defaultSampleDuration, W ? (J.s = s.ReadInt32(M, H), H += 4) : J.s = b.defaultSampleSize, L ? (J.f = s.ReadInt32(M, H), H += 4) : J.f = b.defaultSampleFlags, 33554432 & J.f && b.keyFrames.push(b.sampleCount + B), z && (J.C = s.ReadInt32(M, H), H += 4), T.s += J.s, T.d += J.d, b.sampleSizes.push(J.s), b.duration += J.s, b.stts = b.stts || [], 0 == b.stts.length || b.stts[b.stts.length - 1].d != J.d ? b.stts.push({
                                    c: 1,
                                    d: J.d
                                }) : b.stts[b.stts.length - 1].c++
                            }
                            T.c = V, c = T.o + T.s, b.sampleCount += V, b.stsc = b.stsc || [], 0 != b.stsc.length && b.stsc[b.stsc.length - 1].samples_per_chunk == V || b.stsc.push({
                    ...
                    for (var d in this.esis) {
                        ...
                        for (var Y = 0; Y < b.sampleGroups.length; Y++) {
                            T = b.sampleGroups[Y];
                            Z.push(e.subarray(T.o, T.o + T.s)), b.dataOffsets.push({
                                b: this.chunkIndex - 1,
                                o: n
                            }), b.dataSizes.push(T.s), this.dataOffset += T.s, n += T.s
                        }
                    }
                    t.call(this, null, Z)
                }
                ...
                value: function(e) {
                    if (this.mpd = e, this.init = {}, this.segmentsCount = e.segments.length, e.init_segment) try {
                        ...
                        for (var o = u.getTags("trak", r[0].data), l = 0; l < o.length; l++) {
                            var c = o[l],
                                d = u.getTags("tkhd", c.data),
                                f = s.ReadInt32(d[0].data, 12),
                                p = d[0].data;
                            this.init.tkhd[f] = p;
                            var h = s.ReadInt32(p, 20);
                            0 == h && (h = this.init.duration, s.WriteInt32(p, 20, h));
                            var g = u.getTags("edts", c.data);
                            g.length > 0 && (this.init.edts[f] = g[0].data);
                            var m = u.getTags("mdia", c.data),
    ...
    function(e, t, n) {
        ...
        t.handle = function(e) {
            ...
            o.extension = i.extension || o.extension, c.getHit(e.id) ? f.update(e.id, o) : (e = Object.assign({}, e, o), c.dispatch("hit.new", e), d.execute("quickdownload", e));
            return A(r, n), !0
        }, t.isBulkDetector = _;
        var u = n(1),
            l = u.browser,
        ...
        function w(e) {
            return l.tabs.query({}).then(function(t) {
                var n = null;
                    ...
                    function(e, t) {
                        ...
                        return w(e).then(function(e) {
                            return e ? new Promise(function(t, r) {
                                ...
                                return b[e.id] = 1, l.tabs.update(e.id, {
                                    muted: !0
                                })
                            })
                        })
                ...
                if (n.ids[t]) {
                    ...
                    if (0 === Object.keys(n.ids).length || n.aborted) {
                        delete k[e], w(e).then(function(e) {
                            e && (delete b[e.id], l.tabs.remove(e.id))
                        });
        ...
        u.rpc.listen({
            tbvwsSelectedIds: function(e) {
                ...
                }), t.length > 0 && c.dispatch("hit.delete", t), e.ids.length > 0) {
                    var r = {
                        ...
                        pageUrl: e.pageUrl,
                        topUrl: e.topUrl,
                        thumbnailUrl: l.extension.getURL("/content/images/tbvws.png")
                    };
                    c.dispatch("hit.new", r)
                }
            }
        }), setTimeout(function() {
            var e = function(e) {
                ...
                return s(t, d.DownloadAction), r(t, [{
                    ...
                    key: "cleanup",
                    value: function() {
                        return this.clearAbort(), c.dispatch("hit.delete", this.hit.id), i(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "cleanup", this).call(this)
                    }
                }], [{
                    key: "canPerform",
                    value: function(e) {
            ...
            var t = function(t) {
                ...
                return s(n, e), r(n, [{
                    ...
                    value: function() {
                        ...
                        return Promise.resolve().then(function() {
                            var t = "dlconv#" + e.hit.id;
                            return u.openedContents().indexOf("main") >= 0 ? u.rpc.call("main", "embed", l.extension.getURL("content/dlconv-embed.html?nosaveas=1&panel=" + t)).then(function() {
                                return u.wait(t)
                            }).catch(function(e) {
        ...
        function P() {
            return l.tabs.query({}).then(function(e) {
                return !e.every(function(e) {
                    return !_(e.url)
                })
            })
        }
        l.tabs.onUpdated.addListener(function(e) {
            b[e] && !O && P().then(function(e) {
                e && !O && (O = !0, l.webRequest.onBeforeRequest.addListener(I, {
                    urls: ["<all_urls>"]
                }, ["blocking"]))
            })
        }), l.tabs.onRemoved.addListener(function() {
            O && P().then(function(e) {
                e || (O = !1, l.webRequest.onBeforeRequest.removeListener(I))
            })
        }), l.runtime.getBackgroundPage().then(function(e) {
            l.tabs.query({}).then(function(e) {
                e.forEach(function(e) {
                    v.exec(e.url) && l.tabs.remove(e.id)
                })
            })
        })
    },
    ...
    function(e, t, n) {
        ...
        function g(e) {
            ...
            if (e.bitrate) {
                var l = e.bitrate,
                    c = "bps";
                e.bitrate > 1e7 ? (c = "Mbps", l = Math.round(e.bitrate / 1e6)) : e.bitrate > 1e6 ? (c = "Mbps", l = Math.round(e.bitrate / 1e5) / 10) : e.bitrate > 1e4 ? (c = "Kbps", l = Math.round(e.bitrate / 1e3)) : e.bitrate > 1e3 && (c = "Kbps", l = Math.round(e.bitrate / 100) / 10), o.push(l + c)
            }
            var d = function(e) {
    ...
    function(e, t, n) {
        ...
        t.networkHook = function(e, t) {
            ...
            return l.test(e) ? new Promise(function(t, n) {
                u.request({
                    url: e,
                    onComplete: function(e) {
                        var r = f(e.text);
            ...
            }) : c.test(e) && n && !/_vdh_/.test(e) ? o.tabs.executeScript(t.tabId, {
        ...
        var a = n(1),
            ...
            s = n(12),
            u = n(6),
            l = new RegExp("^https?://[^/]*\\.facebook\\.com/ajax/pagelet/generic\\.php/LitestandTailLoadPagelet"),
            c = new RegExp("^https?://[^/]*\\.facebook\\.com/video/tahoe/async/"),
            d = function() {
                function e(t) {
                    ! function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                                        ...
                                        onComplete: function(a) {
                                            ...
                                            if (200 !== a.status && (i = null), [
                                                ...
                                                (new DOMParser).parseFromString(t.dash_manifest, "application/xml").querySelectorAll("Representation").forEach(function(e) {
                                                    e.getAttribute("mimeType").startsWith("audio") ? l.audio.push(e) : l.video.push(e)
                                                }), l.video.sort(function(e, t) {
                                                ...
                                                }), l.audio.sort(function(e, t) {
                                                    return parseInt(e.getAttribute("audioSamplingRate")) - parseInt(t.getAttribute("audioSamplingRate"))
                                                });
                                                var c = l.audio.length > 0 && l.audio[0].querySelector("BaseURL").textContent || null,
                                                    d = l.audio.length > 0 && parseInt(l.audio[0].getAttribute("bandwidth")) || 0;
                                                l.video.forEach(function(n) {
                                                    ...
                                                    delete l.url, c ? (l.audioUrl = c, l.videoUrl = a, l.adp = !0, l.extension = r ? "mkv" : "mp4") : l.url = a, s.dispatch("hit.new", l)
                                                })
                                            }
                                        }
                                    })
